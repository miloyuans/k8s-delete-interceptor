...
func allWebPermissions() []string {
	out := []string{PermDashboardRead, PermEventsRead, PermSARead, PermSAScan, PermSAMount, PermActorGroupsWrite, PermConfigRead, PermConfigWrite, PermConfigApprove, PermConfigRestore, PermRulesWrite, PermDatasourceWrite, PermTelegramWrite, PermTemplatesWrite, PermSettingsWrite, PermUsersWrite, PermRolesWrite, PermRollbackExecute}
	sort.Strings(out)
	return out
}
